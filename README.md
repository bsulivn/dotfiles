...
- Everforest-colored Ghostty and VS Code app icons
...
The original Ghostty and VS Code artwork is recolored with Everforest tones and stored in `assets/app-icons/`. Install the checked-in icons on macOS with:

```sh
assets/app-icons/install-icons.sh
```

The installer refreshes Finder and Dock caches and ad hoc re-signs the bundles after replacing their sealed icon resources. App updates may restore the vendor icons; run the installer again afterward.
